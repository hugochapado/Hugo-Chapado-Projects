...
int main()
{
    ...
    for(int i=0;i<1000;i++){
        ...
        myMap.insert(to_string(num), name);
    }
    auto t2 = Clock::now();
    ...
    for(long ii=0;ii<10000;ii++){
        int num = rand()+1000000;
        myMap2.insert(to_string(num), name);
    }
    t2 = Clock::now();
    ...
    for(long ii=0;ii<100000;ii++){
        int num = rand()+1000000;
        myMap3.insert(to_string(num), name);
    }
    t2 = Clock::now();
