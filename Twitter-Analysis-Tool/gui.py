...
## Title of project placed into title frame
        self.title = ttk.Label(self.titleFrame, text="Twitter Influence Analysis Tool", font=('Helvetica Neue', 20, 'bold'))
        self.title.place(x=0, y=0)

## Group members place into title frame
        self.authors = ttk.Label(self.titleFrame, text="Written by Hugo Chapado Cruz, Gonzalo Prats Juliani, and Benjamin Zipes", font=('Helvetica Neue', 10))
...
##----------Search Parameters-------------
        self.searchParam = tk.Label(self.root, text="Search Parameters", font=('Consolas', 14, 'bold'), background="white")
